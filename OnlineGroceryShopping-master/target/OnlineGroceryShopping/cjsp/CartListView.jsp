...
function test(){
    ...
    var tt2 = document.getElementById("Q1").value;
    var tsum = tt2;
    if(!isNaN(tsum)){
    	document.getElementById("T1").value = tsum;
}
}
...
<form action="<%=SOTGView.CART_CTL%>" method="post">
                ...
                <table class="table table-striped">
               	 ...
               	 %>
                        <tr>
                            ...
                            <td><input class="form-control" type="text" name="quantity" id="Q1" onchange="test()" value="<%=(bean.getQuantity()==0)?1:bean.getQuantity()%>"/>
                            	<input  type="hidden"  id="T1" name="Q2" />
                            </td>
                            ...
                            <td class="text-right"><a href="<%=SOTGView.CART_LIST_CTL%>?dcid=<%=bean.getId()%>" class="btn btn-sm btn-danger" ><i class="fa fa-trash"></i></a> </td>
                      		...
                      		<td class="text-right">
                      		<input  type="hidden" id="url" value="<%=SOTGView.CART_CTL%>?id=<%=bean.getId()%>&quantity="/>
                      		<a   onclick="myFunction()" class="btn btn-sm btn-primary" >Update</a></td>
        ...
        <div class="col mb-2">
            <div class="row">
                <div class="col-sm-12  col-md-6">
                     <a href="<%=SOTGView.CATEGORY_LIST_CTL%>" class="btn btn-block btn-light" >Continue Shopping</a>
                </div>
