...
public class ContectModel {
	...
	public Integer nextPK() throws DatabaseException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("SELECT MAX(ID) FROM SO_CONTACT");
	...
	public ContectBean findByPK(long pk) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM SO_CONTACT WHERE ID=?");
	...
	public long add(ContectBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("INSERT INTO SO_CONTACT VALUES(?,?,?,?,?,?,?,?)");
			pstmt.setInt(1, pk);
	...
	public void delete(ContectBean bean) throws ApplicationException {
        ...
        try {
            ...
            PreparedStatement pstmt = conn
                    .prepareStatement("DELETE FROM SO_CONTACT WHERE ID=?");
    ...
    public List search(ContectBean bean, int pageNo, int pageSize)
        ...
        StringBuffer sql = new StringBuffer("SELECT * FROM SO_CONTACT WHERE 1=1");
        if (bean != null) {
            if (bean.getId() > 0) {
